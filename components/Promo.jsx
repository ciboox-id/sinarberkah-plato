    ...
    <section className="py-24">
      <div className="container mx-auto flex md:flex-row flex-col items-center">
        <div className="flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center relative">
          ...
          <h2 className="text-sm md:text-offwhite text-dark-main tracking-widest font-bold title-font uppercase mb-1 md:pl-14 top-16 absolute px-14 mt-14">
            Promo
          </h2>
          <h1 className="md:text-5xl text-3xl font-bold title-font md:text-offwhite text-dark-main mb-16 md:pl-14 top-24 absolute px-14 mt-12">
